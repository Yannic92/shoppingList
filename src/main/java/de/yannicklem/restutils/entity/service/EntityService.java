 ...
 */
public interface EntityService<Type extends RestEntity<ID>, ID extends Serializable> extends EntityReadOnlyService<Type, ID>{
     ...
     * @throws de.yannicklem.shoppinglist.core.exception.AlreadyExistsException if an entity that matches to the given entity
     *         already exists.
     */
