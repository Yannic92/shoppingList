 ...
 */
public abstract class AbstractOwnedEntityService<Type extends OwnedRestEntity<ID>, ID extends Serializable> extends AbstractEntityService<Type, ID>
        implements OwnedEntityService<Type, ID> {
